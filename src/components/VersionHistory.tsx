              ...
              >
                ...
                >
                  {gen.type === 'image' && gen.resultUrls[0] && (
                    <Thumb src={gen.resultUrls[0]} type="image" className="w-14 h-14 rounded-lg flex-shrink-0 overflow-hidden" />
                  )}
                  {gen.type === 'video' && gen.resultUrls[0] && (
                    <Thumb src={gen.resultUrls[0]} type="video" className="w-14 h-14 rounded-lg flex-shrink-0 overflow-hidden" />
                  )}
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {gen.resultUrls.map((url, j) => {
                              ...
                              const fname = `v${generations.length - i}-${j + 1}.${ext}`;
                              return (
